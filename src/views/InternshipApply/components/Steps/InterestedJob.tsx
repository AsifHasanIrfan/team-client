      ...
      <div className="w-full min-h-[75%] flex items-center justify-center lg:justify-start px-[60px] md:px-0 lg:pl-[60px]">
        <div>
          <div className="mb-[40px]">
            <h3 className="text-[16px] leading-[22px] font-[500] text-[#1D1D1D] mb-[40px]">
              Select your interested job
            </h3>
            ...
            <div className="flex items-center gap-[16px] flex-wrap max-w-[550px]">
              {jobOptions.map((e, i) => (
                <div
                  ...
                  className={`py-[20px] px-[50px] capitalize leading-[20px] hover:border-red transition-all text-[16px] font-[400] text-[#1D1D1D] border border-[rgba(0,0,0,0.1)] rounded-full cursor-pointer${
          ...
          <div>
            ...
            <input
              ...
              className={`w-full h-[56px] p-[20px] bg-transparent outline-none text-[16px] rounded-[8px] border ${
