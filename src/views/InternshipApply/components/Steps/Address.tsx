...
const Address = () => {
  ...
  const { handlePrev, handleSubmit } = useInternshipApplyHandlers();
        ...
        <div>
          <div className="mb-[25px]">
            ...
            <input
              ...
              className={`w-[360px] md:w-[540px] h-[56px] p-[20px] bg-transparent outline-none text-[16px] rounded-[8px] border ${
                locationErr ? 'border-primary' : 'border-[#cfcfcf]'
              }`}
          ...
          <div className="mb-[25px]">
            ...
            <input
              name="city"
              className={`w-[360px] md:w-[540px] h-[56px] p-[20px] bg-transparent outline-none text-[16px] rounded-[8px] border ${
                cityErr ? 'border-primary' : 'border-[#cfcfcf]'
              }`}
              placeholder="Dhaka"
              onChange={handleChange}
              value={city}
          ...
          <div className="mb-[25px]">
            ...
            <input
              name="state"
              className={`w-[360px] md:w-[540px] h-[56px] p-[20px] bg-transparent outline-none text-[16px] rounded-[8px] border ${
                stateErr ? 'border-primary' : 'border-[#cfcfcf]'
              }`}
              placeholder="Gazipur"
              onChange={handleChange}
              value={state}
          ...
          <div className="mb-[25px]">
            ...
            <input
              name="zip"
              className={`w-[360px] md:w-[540px] h-[56px] p-[20px] bg-transparent outline-none text-[16px] rounded-[8px] border ${
                zipErr ? 'border-primary' : 'border-[#cfcfcf]'
              }`}
              placeholder="3661"
              onChange={handleChange}
              value={zip}
