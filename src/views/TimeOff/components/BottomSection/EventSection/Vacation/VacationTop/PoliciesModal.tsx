...
const PoliciesModal: React.FC<PoliciesModalProps> = ({ open, setOpen }) => {
  return (
    <Modal open={open} setOpen={setOpen} title={'Our Policies'}>
      <div className="w-[330px] md:w-[500px] xl:w-[850px]">
        ...
        <p>
          ...
          <Link
            ...
            passHref={true}
          >
            <a target="_blank">TermsFeed Privacy Policy Generator</a>
          </Link>
          .
        </p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Digital Gregg LLC, CA .
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Digital Gregg Team, accessible
              from{' '}
              <Link
                href="https://https://digitalgreggteam.com/"
                rel="external nofollow noopener"
                passHref={true}
              >
                <a target="_blank">https://https://digitalgreggteam.com/</a>
              </Link>
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          <Link
            ...
            passHref={true}
          >
            <a target="_blank">TermsFeed website</a>
          </Link>{' '}
          article.
        </p>
        <p>
          ...
          <li>
            ...
            <p>
              ...
              <Link
                ...
                passHref={true}
              >
                <a target="_blank">https://mouseflow.com/privacy/</a>
              </Link>
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              <Link
                ...
                passHref={true}
              >
                <a target="_blank">https://www.freshworks.com/privacy/</a>
              </Link>
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>By email: gregg@digitalgregg.com</li>
        </ul>
      </div>
    </Modal>
  );
